...
@Component({
  selector: 'app-opticallist',
  templateUrl: './opticallist.component.html',
  styleUrls: ['./opticallist.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class OpticallistComponent implements OnInit {
  ...
  onSortData(column:any) {
    ...
    this.getOpticalList(`${column}:${this.sortOrder}`);
  }
  ...
  ngOnInit(): void {
    ...
    this.resetDate();
    this.getOpticalList(`${this.sortColumn}:${this.sortOrder}`);
    setTimeout(() => {
  ...
  private getOpticalList(sort:any=''): void {
    this.pushColumns();
    let reqData = {
      page: this.page,
      limit: this.pageSize,
