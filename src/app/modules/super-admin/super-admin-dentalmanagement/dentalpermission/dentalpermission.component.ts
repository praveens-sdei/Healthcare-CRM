...
@Component({
  selector: 'app-dentalpermission',
  templateUrl: './dentalpermission.component.html',
  styleUrls: ['./dentalpermission.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class DentalpermissionComponent implements OnInit {
  ...
  clickBack() {
    this.route.navigate([`/super-admin/individualdental/basicinfo/${this.dentalId}`])
  }
