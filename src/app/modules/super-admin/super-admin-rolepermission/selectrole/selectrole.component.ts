...
selectall:any=false
  ...
  private getAllStaff() {
    this._pharmacy.gettAllStaffListing({ for_user: this.userID }).subscribe({
      next: (result: any) => {
        ...
        // })
        // console.log("decryptedData?.body=====",decryptedData?.body)
    ...
    this._pharmacy.getUserMenus(params).subscribe(
      (res: any) => {
        ...
        for (const data of decryptedData.body) {
          ...
          if (data.menu_id._id != "63d78c7c72e516c629eccfde") {
  ...
  makeJSON(value: any, menuID: any, order: any) {
    ...
    if (value) {
      ...
      console.log(this.selectedMenuItem, "this.selectedMenuItem[checkIndex].isMenuSelected")
          ...
          if (!data.parent_id) {
            ...
            this.selectedMenuItem.forEach((element: any, index: any) => {
              ...
              if (objData1 == parentid) {
                console.log("true", "decryptedData", element, this.selectedMenuItem[index].isMenuSelected);
