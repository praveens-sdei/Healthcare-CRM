...
@Component({
  selector: 'app-hospital-medicalproduct-test',
  templateUrl: './hospital-medicalproduct-test.component.html',
  styleUrls: ['./hospital-medicalproduct-test.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class HospitalMedicalproductTestComponent implements OnInit {
  ...
  getMedicines(sort:any='') {
    ...
    this.service.getmedicineList(
      ...
      console.log(this.dataSource,"dataSource_____");
