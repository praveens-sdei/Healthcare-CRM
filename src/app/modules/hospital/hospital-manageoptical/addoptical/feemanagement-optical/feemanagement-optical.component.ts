...
@Component({
  selector: 'app-feemanagement-optical',
  templateUrl: './feemanagement-optical.component.html',
  styleUrls: ['./feemanagement-optical.component.scss']
})
export class FeemanagementOpticalComponent implements OnInit {
