...
@Component({
  selector: 'app-documentmanage-optical',
  templateUrl: './documentmanage-optical.component.html',
  styleUrls: ['./documentmanage-optical.component.scss']
})
export class DocumentmanageOpticalComponent implements OnInit {
