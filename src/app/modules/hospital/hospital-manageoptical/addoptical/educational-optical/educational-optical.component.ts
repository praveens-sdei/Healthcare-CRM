...
@Component({
  selector: 'app-educational-optical',
  templateUrl: './educational-optical.component.html',
  styleUrls: ['./educational-optical.component.scss']
})
export class EducationalOpticalComponent implements OnInit {
