...
@Component({
  selector: 'app-availability-optical',
  templateUrl: './availability-optical.component.html',
  styleUrls: ['./availability-optical.component.scss']
})
export class AvailabilityOpticalComponent implements OnInit {
