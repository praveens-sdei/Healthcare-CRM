...
@Component({
  selector: "app-basicinfo-optical",
  templateUrl: "./basicinfo-optical.component.html",
  styleUrls: ["./basicinfo-optical.component.scss"],
})
export class BasicinfoOpticalComponent implements OnInit {
  ...
  async handleSaveBasicInfo() {
    ...
    console.log("this.basicInfo.invalid>>>>>>>", this.basicInfo.value);
  ...
  onFileSelected(event, type: "profile" | "license") {
    ...
    formData.append("portalType", "Optical");
