...
@Component({
  selector: 'app-location-optical',
  templateUrl: './location-optical.component.html',
  styleUrls: ['./location-optical.component.scss']
})
export class LocationOpticalComponent implements OnInit {
