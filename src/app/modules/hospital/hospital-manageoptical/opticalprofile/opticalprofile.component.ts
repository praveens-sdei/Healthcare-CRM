...
@Component({
  selector: 'app-opticalprofile',
  templateUrl: './opticalprofile.component.html',
  styleUrls: ['./opticalprofile.component.scss']
})
export class OpticalprofileComponent implements OnInit {
  ...
  getProfileDetails() {
    ...
    this.fourportalservice.getProfileDetailsById(reqData ).subscribe(
      (res) => {
        ...
        console.log("this.feeManagementArray>>>>>>",this.feeManagementArray)
