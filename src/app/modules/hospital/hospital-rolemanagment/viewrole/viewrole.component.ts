...
export class ViewroleComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private fb: FormBuilder, private _route: Router,
    ...
    private _coreService: CoreService, private auth: AuthService, private loader: NgxUiLoaderService
  ) {
  ...
  //     is_delete: "Yes"
  //   }
  //   this._hospitalService.deleteRole(data).subscribe((res) => {
  ...
  roleList(sort: any = '') {
    ...
    this._hospitalService.allRoles(reqData).subscribe(
      (res: any) => {
  ...
  //     userId:this.userID
  //   }
  //   this._hospitalService.allRole(this.userID).subscribe((res) => {
  ...
  addRole() {
    ...
    this._hospitalService.addRole(addData).subscribe((res) => {
      let result = this._coreService.decryptObjectData({ data: res });
      console.log(result);
      if (result.status) {
        this._coreService.showSuccess(result.message, '');
