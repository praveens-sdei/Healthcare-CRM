...
export class PaymentComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private activeRoute: ActivatedRoute,
    private hospitalService: HospitalService, private _coreService: CoreService,
  ...
  ngOnInit(): void {
    ...
    this.hospitalService.getHospitalSubscriptionPlanDetails(paramData).subscribe({
      next: (res) => {
        let paymentReq = {};
        ...
        paymentReq = {
          ...
          description: 'hospital Plan Subscription',
        ...
        console.log("INTENT REQDATA====>",paymentReq)
  ...
  private createPaymentIntent(reqData: any): Observable<PaymentIntent> {
    ...
    return this.http.post<PaymentIntent>(
      environment.apiUrl+`/healthcare-crm-hospital/payment/create-payment-intent`,
       reqData,{
