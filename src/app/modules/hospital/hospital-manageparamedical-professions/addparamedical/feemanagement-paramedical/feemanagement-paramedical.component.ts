...
@Component({
  selector: 'app-feemanagement-paramedical',
  templateUrl: './feemanagement-paramedical.component.html',
  styleUrls: ['./feemanagement-paramedical.component.scss']
})
export class FeemanagementParamedicalComponent implements OnInit {
