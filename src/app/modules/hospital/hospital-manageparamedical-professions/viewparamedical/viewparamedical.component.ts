...
@Component({
  selector: 'app-viewparamedical',
  templateUrl: './viewparamedical.component.html',
  styleUrls: ['./viewparamedical.component.scss']
})
export class ViewparamedicalComponent implements OnInit {
