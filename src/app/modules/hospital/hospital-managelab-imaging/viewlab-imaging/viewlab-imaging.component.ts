...
@Component({
  selector: 'app-viewlab-imaging',
  templateUrl: './viewlab-imaging.component.html',
  styleUrls: ['./viewlab-imaging.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ViewlabImagingComponent implements OnInit {
