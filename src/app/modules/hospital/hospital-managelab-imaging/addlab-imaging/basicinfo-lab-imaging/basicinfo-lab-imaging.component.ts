...
@Component({
  selector: "app-basicinfo-lab-imaging",
  templateUrl: "./basicinfo-lab-imaging.component.html",
  styleUrls: ["./basicinfo-lab-imaging.component.scss"],
})
export class BasicinfoLabImagingComponent implements OnInit {
  ...
  getExperties() {
    this.service.getAllExperties(this.hospitalId).subscribe((res) => {
      ...
      // });
      this.basicInfo.get("expertise").patchValue(this.profileDetails?.expertise[0]._id)
      console.log("expertiesListt==========>", this.profileDetails?.expertise[0]._id);
    });
  }
