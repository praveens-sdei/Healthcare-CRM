...
@Component({
  selector: 'app-addlab-imaging',
  templateUrl: './addlab-imaging.component.html',
  styleUrls: ['./addlab-imaging.component.scss'],
  encapsulation: ViewEncapsulation.None,
  exportAs: "mainStepper",
})
export class AddlabImagingComponent implements OnInit {
