...
@Component({
  selector: 'app-location-lab-imaging',
  templateUrl: './location-lab-imaging.component.html',
  styleUrls: ['./location-lab-imaging.component.scss']
})
export class LocationLabImagingComponent implements OnInit {
