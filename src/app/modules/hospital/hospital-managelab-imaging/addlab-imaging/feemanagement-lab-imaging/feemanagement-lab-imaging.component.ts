...
@Component({
  selector: 'app-feemanagement-lab-imaging',
  templateUrl: './feemanagement-lab-imaging.component.html',
  styleUrls: ['./feemanagement-lab-imaging.component.scss']
})
export class FeemanagementLabImagingComponent implements OnInit {
