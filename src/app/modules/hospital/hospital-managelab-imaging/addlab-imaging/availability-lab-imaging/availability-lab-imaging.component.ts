...
@Component({
  selector: 'app-availability-lab-imaging',
  templateUrl: './availability-lab-imaging.component.html',
  styleUrls: ['./availability-lab-imaging.component.scss']
})
export class AvailabilityLabImagingComponent implements OnInit {
