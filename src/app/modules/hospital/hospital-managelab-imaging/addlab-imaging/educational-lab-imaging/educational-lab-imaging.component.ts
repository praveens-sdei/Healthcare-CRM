...
@Component({
  selector: 'app-educational-lab-imaging',
  templateUrl: './educational-lab-imaging.component.html',
  styleUrls: ['./educational-lab-imaging.component.scss']
})
export class EducationalLabImagingComponent implements OnInit {
