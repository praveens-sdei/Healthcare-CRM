...
@Component({
  selector: 'app-lab-imagingprofile',
  templateUrl: './lab-imagingprofile.component.html',
  styleUrls: ['./lab-imagingprofile.component.scss']
})
export class LabImagingprofileComponent implements OnInit {
  doctorId: any = "";
  profileDetails: any;
