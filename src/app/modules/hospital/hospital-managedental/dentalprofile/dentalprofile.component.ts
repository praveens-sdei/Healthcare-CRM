...
@Component({
  selector: 'app-dentalprofile',
  templateUrl: './dentalprofile.component.html',
  styleUrls: ['./dentalprofile.component.scss']
})
export class DentalprofileComponent implements OnInit {
