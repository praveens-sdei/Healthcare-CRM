...
@Component({
  selector: 'app-location-dental',
  templateUrl: './location-dental.component.html',
  styleUrls: ['./location-dental.component.scss']
})
export class LocationDentalComponent implements OnInit {
