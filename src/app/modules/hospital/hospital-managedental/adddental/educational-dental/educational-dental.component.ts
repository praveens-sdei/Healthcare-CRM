...
@Component({
  selector: 'app-educational-dental',
  templateUrl: './educational-dental.component.html',
  styleUrls: ['./educational-dental.component.scss']
})
export class EducationalDentalComponent implements OnInit {
