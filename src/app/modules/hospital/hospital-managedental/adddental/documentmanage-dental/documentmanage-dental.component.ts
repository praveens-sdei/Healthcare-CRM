...
@Component({
  selector: 'app-documentmanage-dental',
  templateUrl: './documentmanage-dental.component.html',
  styleUrls: ['./documentmanage-dental.component.scss']
})
export class DocumentmanageDentalComponent implements OnInit {
