...
@Component({
  selector: 'app-hopitalizationclaim-view',
  templateUrl: './hopitalizationclaim-view.component.html',
  styleUrls: ['./hopitalizationclaim-view.component.scss']
})
export class HopitalizationclaimViewComponent implements OnInit {
