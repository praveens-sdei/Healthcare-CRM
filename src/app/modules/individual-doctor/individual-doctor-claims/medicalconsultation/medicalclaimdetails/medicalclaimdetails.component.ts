...
@Component({
  selector: 'app-medicalclaimdetails',
  templateUrl: './medicalclaimdetails.component.html',
  styleUrls: ['./medicalclaimdetails.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class MedicalclaimdetailsComponent implements OnInit {
