...
// @Component({
//   selector: 'app-medicalclaimview',
//   templateUrl: './medicalclaimview.component.html',
//   styleUrls: ['./medicalclaimview.component.scss'],
...
export class MedicalclaimviewComponent implements OnInit {
  ...
  getClaimList(sort: any = '') {
    ...
    this.pharmacyPlanService.medicineClaimListDoctor(reqData).subscribe((res) => {
      ...
      console.log("All Medicine claims ---->1", response);
