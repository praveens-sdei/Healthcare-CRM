...
@Component({
  selector: 'app-documentupload-hospital',
  templateUrl: './documentupload-hospital.component.html',
  styleUrls: ['./documentupload-hospital.component.scss']
})
export class DocumentuploadHospitalComponent implements OnInit {
