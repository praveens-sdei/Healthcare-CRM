...
@Component({
  selector: 'app-servicetype-hospital',
  templateUrl: './servicetype-hospital.component.html',
  styleUrls: ['./servicetype-hospital.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ServicetypeHospitalComponent implements OnInit {
  ...
  constructor(
    ...
    this.insuranceSubcription = this.coreService.SharingInsId.subscribe(
      (res) => {
        if (res != "default") {
          ...
          console.log(this.stepOneId, "this.stepOneId123");
    ...
    if (this.stepOneId == null || this.insuranceId == null) {
      this.router.createUrlTree(["/individual-doctor/claims"]);
    }
          ...
          next: async (res) => {
            ...
            if (this.type != '') {
              ...
              this.medicineForm.patchValue({
                ...
                hospitalizatinExtensionDetails: claimData?.hospitalservicedatas[0]?.hospitalizatinExtensionDetails,
  ...
  ngOnInit(): void {
    ...
    console.log("service construcotr call==============================>");
    this.stepOneId = this.coreService.getSessionStorage("stepOneId");
    console.log(this.stepOneId, "check stepOneId constructor12");
    let user = JSON.parse(localStorage.getItem("loginData"));
    this.pharmacyId = user?._id;
    this.loggedInuserId = user?._id;
    console.log(this.loggedInuserId, "selectclaimidselectclaimid")
    console.log("selectclaimid", this.selectclaimid);
    this.stepOneId = this.coreService.getSessionStorage("stepOneId");
    console.log(this.stepOneId, "check stepOneId constructor");
  ...
  removeMedicine(index: number) {
    ...
    console.log(this.medicineList, "before splice", this.medicineIDObject, "", this.medicineNameObject);
  ...
  checkPregnancyRelated(event) {
    console.log(event, "chjeck envnet");
  ...
  checkRequestedType(event) {
    console.log(event, "chjeck envnet23");
  ...
  categoryChange(event) {
    console.log(event, "chjeck envnet12");
  ...
  checkmedicineId(id) {
    console.log(id, "check id", this.removeMedicineServiceType);
