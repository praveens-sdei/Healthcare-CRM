...
@Component({
  selector: "app-individual-doctor-createprofile",
  templateUrl: "./individual-doctor-createprofile.component.html",
  styleUrls: ["./individual-doctor-createprofile.component.scss"],
})
export class IndividualDoctorCreateprofileComponent implements OnInit {
  ...
  getDoctorDetails() {
    ...
    this.service.getDoctorBasicInfo(this.doctorId).subscribe((res) => {
    ...
    this.service.basicInformation(reqData).subscribe(
      (res) => {
        ...
        if (response.status) {
          ...
          // this.individualDoctorService.hospitalLogin(this.loginCreds).subscribe((res) => {
          //   try {
          //     let result = this.coreService.decryptObjectData({ data: res });
          //     console.log(result, "result");

          //     if (result.errorCode === "PROFILE_NOT_APPROVED") {
          //       this.coreService.showError(result.errorCode, "");
          //       this.route.navigate(["individual-doctor/login"]);
          //       return;
          //     }
