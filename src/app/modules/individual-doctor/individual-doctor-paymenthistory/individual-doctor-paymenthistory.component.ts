...
@Component({
  selector: 'app-individual-doctor-paymenthistory',
  templateUrl: './individual-doctor-paymenthistory.component.html',
  styleUrls: ['./individual-doctor-paymenthistory.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class IndividualDoctorPaymenthistoryComponent implements OnInit {
  ...
  patientPaymentHistoryListToDoc() {
    ...
    this._doctorService.patientPaymentHistoryToDoc(data).subscribe((res: any) => {
