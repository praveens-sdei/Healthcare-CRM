...
@Component({
  selector: 'app-compalintlist',
  templateUrl: './compalintlist.component.html',
  styleUrls: ['./compalintlist.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class CompalintlistComponent implements OnInit {
