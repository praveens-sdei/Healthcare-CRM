...
@Component({
  selector: 'app-patient-medicalconsultationlist',
  templateUrl: './patient-medicalconsultationlist.component.html',
  styleUrls: ['./patient-medicalconsultationlist.component.scss'],
...
export class PatientMedicalconsultationlistComponent implements OnInit {
  ...
  getClaimList(sort:any='') {
    ...
    this.pharmacyPlanService.medicineClaimListDoctor(reqData).subscribe((res) => {
  ...
  getStatusCount() {
    this.pharmacyPlanService
      .medicineClaimCountByStatusPharmacyDoctor(this.pharmacyId, this.selectedinsurance.join(","))
      .subscribe((res) => {
        let response = this.coreService.decryptObjectData({ data: res });
  ...
  editclaim(claim_id, type = '') {
    this.router.navigate(["/patient/medicalconsultation/submitclaim"], {
    ...
    this.pharmacyPlanService.medicineClaimListDoctor(reqData).subscribe((res) => {
      let response = this.coreService.decryptObjectData({ data: res });
        if(response.status == true){
          ...
          var fileName = 'patientMedicalConsultationExcel.xlsx';
