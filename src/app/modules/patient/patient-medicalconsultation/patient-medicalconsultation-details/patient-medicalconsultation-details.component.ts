...
@Component({
  selector: 'app-patient-medicalconsultation-details',
  templateUrl: './patient-medicalconsultation-details.component.html',
  styleUrls: ['./patient-medicalconsultation-details.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PatientMedicalconsultationDetailsComponent implements OnInit {
