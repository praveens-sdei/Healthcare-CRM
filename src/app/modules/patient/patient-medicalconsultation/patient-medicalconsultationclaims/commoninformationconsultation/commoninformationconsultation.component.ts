...
export class CommoninformationconsultationComponent implements OnInit {
            ...
            next: async (res) => {
                ...
                if (result.status) {
                    ...
                    this.deliverTitleselected =
                        claimData?.prescriberCenterInfo?.prescriberTitle;
    ...
    getSpecialty() {
        ...
        this._superAdminService.listSpeciality(param).subscribe({
            next: (res) => {
                ...
                this.specialtyList = [];
                result.body?.data.map((curentval) => {
    ...
    async autogetInsuranceId(event: any, patientId: any) {
        ...
        this.pharmacyService.getAllSubscriber(param).subscribe({
            next: async (res) => {
                ...
                console.log(this.patientDetailList, "patientDetailList");
    ...
    onPrescriberCenterChange(selectedLocation: any) {
        ...
        console.log('Location List:', this.locationList12);
    ...
    onPrescriberDoctorList(selectedValue: string) {
        ...
        if (ePrescriptionNumber) {
            ...
            this._pharmacyService
                ...
                .subscribe((res) => {
                    ...
                    this.appointmentId = response.body.appointmentId;
                    ...
                    if (response.body.subscriberId == "") {
                        ...
                        if (response.status) {
                            ...
                            this.fourthFormGroup.patchValue({
                                prescriberCenter: response?.body?.prescriberCenterDetails?.prescriberCenter,
                                prescriberFName:
    ...
    async getRecordByCustomId(customId) {
        return new Promise(resolve => {
            ...
            this.fourthFormGroup.patchValue({
                ...
                prescriberTitle: this.matchedRecord?.title,
                // prescriberSpecialty:
                //   response?.body?.prescriberCenterDetails?.prescriberSpeciality,
            });
    ...
    getDoctorList() {
        ...
        this.hospitalservice.getDoctorsFourPortalList(reqData).subscribe((res) => {
            let response = this.coreService.decryptObjectData({ data: res });
