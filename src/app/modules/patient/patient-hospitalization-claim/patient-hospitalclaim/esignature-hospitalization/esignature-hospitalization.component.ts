...
@Component({
  selector: 'app-esignature-hospitalization',
  templateUrl: './esignature-hospitalization.component.html',
  styleUrls: ['./esignature-hospitalization.component.scss']
})
export class EsignatureHospitalizationComponent implements OnInit {
