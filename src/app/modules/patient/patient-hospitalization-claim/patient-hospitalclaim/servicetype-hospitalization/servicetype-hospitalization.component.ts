...
@Component({
  selector: 'app-servicetype-hospitalization',
  templateUrl: './servicetype-hospitalization.component.html',
  styleUrls: ['./servicetype-hospitalization.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ServicetypeHospitalizationComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.medicineForm.value.medicines.map((data, index) => {
      ...
      medicineArray.push({
        ...
        frequency: "",
        duration: "",
        date_of_Pregnancy: data.date_of_Pregnancy ? data.date_of_Pregnancy : null,
