...
@Component({
  selector: 'app-patient-hospitalclaim-details',
  templateUrl: './patient-hospitalclaim-details.component.html',
  styleUrls: ['./patient-hospitalclaim-details.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PatientHospitalclaimDetailsComponent implements OnInit {
