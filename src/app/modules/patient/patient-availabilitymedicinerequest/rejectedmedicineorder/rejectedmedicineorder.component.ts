...
@Component({
  selector: 'app-rejectedmedicineorder',
  templateUrl: './rejectedmedicineorder.component.html',
  styleUrls: ['./rejectedmedicineorder.component.scss']
})
export class RejectedmedicineorderComponent implements OnInit {
  pharmacy_id: string = "";
  order_id: string = "";
  patient_details: any;
