  ...
  portal_Details() {
    ...
    this.fourPortalService.fourPortalDetails(param).subscribe({
      next: async (res) => {
        ...
        console.log(this.portaldetailsData, "portaldetailsDataaa_____");
          ...
          if (res === true) {
            this._PatientService.fourPortal_bookAppointment(param).subscribe({
              next: (res) => {
                ...
                console.log("BOOK_APPOINTMENT_________________", result);
    ...
    if (this.AppointmentDetail_id) {
      ...
      this._PatientService.fourPortal_viewAppointment(prama).subscribe({
        next: async (res) => {
          ...
          console.log("abc------->", result.data.result.consultationDate);
