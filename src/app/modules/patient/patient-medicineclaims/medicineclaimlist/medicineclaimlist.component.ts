...
@Component({
  selector: 'app-medicineclaimlist',
  templateUrl: './medicineclaimlist.component.html',
  styleUrls: ['./medicineclaimlist.component.scss'],
...
export class MedicineclaimlistComponent implements OnInit {
  ...
  getClaimList() {
    ...
    this.patientSerivice.medicineClaimList(reqData).subscribe((res) => {
  ...
  getStatusCount() {
    this.patientSerivice
      .getClaimsStatusCount(this.patientId)
      .subscribe((res) => {
        let response = this.coreService.decryptObjectData({ data: res });
    ...
    this.patientSerivice.medicineClaimList(reqData).subscribe((res) => {
      let response = this.coreService.decryptObjectData({ data: res });     
        if(response.status == true){
          ...
          var fileName = 'patientMedicineExcel.xlsx';
