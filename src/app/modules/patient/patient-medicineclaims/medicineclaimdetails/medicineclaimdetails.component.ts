...
@Component({
  selector: 'app-medicineclaimdetails',
  templateUrl: './medicineclaimdetails.component.html',
  styleUrls: ['./medicineclaimdetails.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class MedicineclaimdetailsComponent implements OnInit {
