...
@Component({
  selector: 'app-dental-price-request',
  templateUrl: './dental-price-request.component.html',
  styleUrls: ['./dental-price-request.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DentalPriceRequestComponent implements OnInit {
