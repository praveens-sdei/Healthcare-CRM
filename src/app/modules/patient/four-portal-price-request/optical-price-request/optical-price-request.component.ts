...
@Component({
  selector: 'app-optical-price-request',
  templateUrl: './optical-price-request.component.html',
  styleUrls: ['./optical-price-request.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class OpticalPriceRequestComponent implements OnInit {
