...
@Component({
  selector: 'app-paramedical-profession-price-request',
  templateUrl: './paramedical-profession-price-request.component.html',
  styleUrls: ['./paramedical-profession-price-request.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class ParamedicalProfessionPriceRequestComponent implements OnInit {
