...
@Component({
  selector: 'app-lab-imaging-price-request',
  templateUrl: './lab-imaging-price-request.component.html',
  styleUrls: ['./lab-imaging-price-request.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class LabImagingPriceRequestComponent implements OnInit {
