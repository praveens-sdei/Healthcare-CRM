...
@Component({
  selector: 'app-detail-avalibililty',
  templateUrl: './detail-avalibililty.component.html',
  styleUrls: ['./detail-avalibililty.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class DetailAvalibililtyComponent implements OnInit {
  portal_id: string = "";
  order_id: string = "";
  patient_details: any;
