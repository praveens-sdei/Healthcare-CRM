...
@Component({
  selector: 'app-patient-fourt-portal-appointment-details',
  templateUrl: './patient-fourt-portal-appointment-details.component.html',
  styleUrls: ['./patient-fourt-portal-appointment-details.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PatientFourtPortalAppointmentDetailsComponent implements OnInit {
