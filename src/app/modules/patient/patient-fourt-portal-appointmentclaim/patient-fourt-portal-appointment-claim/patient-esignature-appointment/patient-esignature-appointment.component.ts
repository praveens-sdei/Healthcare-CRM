...
@Component({
  selector: 'app-patient-esignature-appointment',
  templateUrl: './patient-esignature-appointment.component.html',
  styleUrls: ['./patient-esignature-appointment.component.scss']
})
export class PatientEsignatureAppointmentComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    this.full_name.nativeElement.value =
      this.coreService.getLocalStorage("loginData").full_name;
