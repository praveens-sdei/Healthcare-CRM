...
@Component({
  selector: 'app-patient-documentupload-appointment',
  templateUrl: './patient-documentupload-appointment.component.html',
  styleUrls: ['./patient-documentupload-appointment.component.scss']
})
export class PatientDocumentuploadAppointmentComponent implements OnInit {
