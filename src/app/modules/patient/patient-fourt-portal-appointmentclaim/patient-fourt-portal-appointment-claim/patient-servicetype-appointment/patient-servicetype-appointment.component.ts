...
@Component({
  selector: 'app-patient-servicetype-appointment',
  templateUrl: './patient-servicetype-appointment.component.html',
  styleUrls: ['./patient-servicetype-appointment.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PatientServicetypeAppointmentComponent implements OnInit {
  ...
  redeemed: any = [];
  serviceLimit: any = [];
  planValidityTo: string | number | Date;
  waitingCount: any = [];
  ...
  constructor(
    ...
    this.ePrescriptionData =
      this.coreService.SharingEprescriptionData.subscribe((res: any) => {
        // this.getAllappointmentReason();
        console.log(res.reasonForAppointment, "check log res");
  ...
  ngOnInit(): void {
    ...
    console.log(this.pharmacyId, "selectclaimidselectclaimid")
    if (this.selectclaimid == undefined || this.selectclaimid == '') {
      this.addNewMedicine('', '', '', '', '', 0);

      // this.getMedicineList();
    }
    this.doctorIdSelected = this.coreService.getSessionStorage("doctorIdSelected");
    // this.getAllappointmentReason();
  ...
  //   // let excReimburmentRate = 1;
  //   let reqAmt = 0;
  //   console.log(this.planExclusion, "planExclusion");
  ...
  //   //   reqAmt = (this.reimbursmentRate / 100) * totalCost;
  //   // } else {
  //   //   reqAmt = (excReimburmentRate / 100) * totalCost;
  //   // }
