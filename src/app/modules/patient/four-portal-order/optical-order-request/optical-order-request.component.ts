...
@Component({
  selector: 'app-optical-order-request',
  templateUrl: './optical-order-request.component.html',
  styleUrls: ['./optical-order-request.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class OpticalOrderRequestComponent implements OnInit {
