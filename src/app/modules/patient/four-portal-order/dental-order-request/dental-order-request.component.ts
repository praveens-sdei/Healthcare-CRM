...
@Component({
  selector: 'app-dental-order-request',
  templateUrl: './dental-order-request.component.html',
  styleUrls: ['./dental-order-request.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class DentalOrderRequestComponent implements OnInit {
