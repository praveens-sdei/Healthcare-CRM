...
@Component({
  selector: 'app-patient-four-portal-claim-details',
  templateUrl: './patient-four-portal-claim-details.component.html',
  styleUrls: ['./patient-four-portal-claim-details.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PatientFourPortalClaimDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log(this.claimID, "check claim idssss");
