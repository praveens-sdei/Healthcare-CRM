...
@Component({
  selector: 'app-documentupload-four-portal',
  templateUrl: './documentupload-four-portal.component.html',
  styleUrls: ['./documentupload-four-portal.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DocumentuploadFourPortalComponent implements OnInit {
