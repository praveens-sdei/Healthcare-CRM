...
@Component({
  selector: 'app-esignature-four-portal',
  templateUrl: './esignature-four-portal.component.html',
  styleUrls: ['./esignature-four-portal.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class EsignatureFourPortalComponent implements OnInit {
  ...
  submitClaim() {
    ...
    this.pharmacyPlanService.finalSubmitClaimFourPortal(data).subscribe({
      next: async (res) => {
