...
console.log("run 11111111")
        ...
        for (const data of decryptedData.body) {
            ...
            if(data.menu_id._id != "63b3c678e7d24431d4432633" && data.menu_id._id !="63b3c5ece7d24431d443262f"){
...
// console.log(userPermission, "userPermission",this.selectedMenuItem)
  ...
  addRole() {
    ...
    // this._pharmacy.addRole(this.roleForm.value).subscribe((res) => {
