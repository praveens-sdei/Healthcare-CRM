...
@Component({
  selector: 'app-pharmacy-medicalproductstests',
  templateUrl: './pharmacy-medicalproductstests.component.html',
  styleUrls: ['./pharmacy-medicalproductstests.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PharmacyMedicalproductstestsComponent implements OnInit {
