...
@Component({
  selector: "app-mediclaimdetail",
  templateUrl: "./mediclaimdetail.component.html",
  styleUrls: ["./mediclaimdetail.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class MediclaimdetailComponent implements OnInit {
  ...
  userPermission(userPermission: any, arg1: string, menuID: string) {
