...
@Component({
  selector: 'app-pharmacy-userinvitaion',
  templateUrl: './pharmacy-userinvitaion.component.html',
  styleUrls: ['./pharmacy-userinvitaion.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PharmacyUserinvitaionComponent implements OnInit {
  userPermission: any;
  userRole: any;
