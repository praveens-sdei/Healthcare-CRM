...
@Component({
  selector: 'app-patient-medical-document',
  templateUrl: './patient-medical-document.component.html',
  styleUrls: ['./patient-medical-document.component.scss'],
})
export class PatientMedicalDocumentComponent implements OnInit {
