...
export class ViewpatientComponent implements OnInit {
  ...
  constructor(
    ...
    if(this.userRole === 'STAFF'){
      this.doctorId = adminData.creatorId;
  ...
  getPatientList(sort:any='') {
    ...
    this.fourPortalService.getPatientListAddedByFourPortal(reqData).subscribe((res) => {
  ...
  activeLockDeleteDoctor(action: string, value: boolean) {
    ...
    this.fourPortalService.activeAndLockPatient(reqData).subscribe((res) => {
      let response = this.coreService.decryptObjectData({ data: res });
  ...
  routeToEdit(id) {
    ...
    this.route.navigate([`/portals/patientmanagement/${this.userType}/edit`, id]);
  }

  routeToAdd(){
    this.route.navigate([`/portals/patientmanagement/${this.userType}/add`]);
  }

  routeToDetails(id){
    this.route.navigate([`/portals/patientmanagement/${this.userType}/details`, id]);
  }
}
