...
@Component({
  selector: 'app-four-portal-medicineclaim-details',
  templateUrl: './four-portal-medicineclaim-details.component.html',
  styleUrls: ['./four-portal-medicineclaim-details.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class FourPortalMedicineclaimDetailsComponent implements OnInit {
