...
@Component({
  selector: 'app-availability-fourportal',
  templateUrl: './availability-fourportal.component.html',
  styleUrls: ['./availability-fourportal.component.scss']
})
export class AvailabilityFourportalComponent implements OnInit, OnChanges {
  ...
  //     type:this.userType
  //   }
  //   this.fourportal.getProfileDetailsById(reqData ).subscribe((res) => {
  ...
  getDoctorDetails(fromParent: any) {
    ...
    this.patchValuesAsPerLocation(this.availability);
  }
  ...
  saveAvailability(isNext: any = "") {
    ...
    let reqData = {
      ...
      // portal_user_id: sessionStorage.getItem("doctorId"),
