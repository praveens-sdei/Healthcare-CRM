...
@Component({
  selector: 'app-four-portal-editprofile',
  templateUrl: './four-portal-editprofile.component.html',
  styleUrls: ['./four-portal-editprofile.component.scss'],
  encapsulation: ViewEncapsulation.None,
  exportAs: "mainStepper",
})
export class FourPortalEditprofileComponent implements OnInit {
