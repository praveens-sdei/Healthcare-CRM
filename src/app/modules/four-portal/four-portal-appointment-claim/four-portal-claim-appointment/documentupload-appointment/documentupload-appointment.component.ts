...
@Component({
  selector: 'app-documentupload-appointment',
  templateUrl: './documentupload-appointment.component.html',
  styleUrls: ['./documentupload-appointment.component.scss']
})
export class DocumentuploadAppointmentComponent implements OnInit {
