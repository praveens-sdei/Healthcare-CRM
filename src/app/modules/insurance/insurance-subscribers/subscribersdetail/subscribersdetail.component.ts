...
@Component({
  selector: 'app-subscribersdetail',
  templateUrl: './subscribersdetail.component.html',
  styleUrls: ['./subscribersdetail.component.scss']
})
export class SubscribersdetailComponent implements OnInit {
  ...
  viewSubscriberDetails() {
    this.insuranceSubscriber.viewSubscriberDetails(this.subscriberID).subscribe((res: any) => {
      ...
      console.log(decryptedData, 'decryptedDataa');
      this.subscriberDetails = decryptedData.body.subscriber_details;
      console.log(this.subscriberDetails,"subscriberDetailsss_____");

      // List all Plan service
      const plan_services = decryptedData.body.plan_services;
       console.log(plan_services,"plan_servicesssss___");
