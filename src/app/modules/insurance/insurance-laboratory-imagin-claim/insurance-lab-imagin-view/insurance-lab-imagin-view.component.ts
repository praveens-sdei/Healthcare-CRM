...
@Component({
  selector: 'app-insurance-lab-imagin-view',
  templateUrl: './insurance-lab-imagin-view.component.html',
  styleUrls: ['./insurance-lab-imagin-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceLabImaginViewComponent implements OnInit {
  ...
  checkInnerPermission(){
    ...
    console.log("checkData_____________",checkData);
    ...
    if(checkData){
      if(checkData.isChildKey == true){
        ...
        if (checkSubmenu.hasOwnProperty("imaging-claim")) {
          this.innerMenuPremission = checkSubmenu['imaging-claim'].inner_menu;
  ...
  getMedicineClaimList(sort: any = '') {
    let reqData = {
      ...
      claimType: "Laboratory-Imaging-order",
  ...
  async handleViewDetails(claimId) {
    console.log(claimId);
    this.router.navigate(["/insurance/imaging-claim/details"], {
      queryParams: {
        claimId: claimId,
      },
    });
