...
@Component({
  selector: 'app-servicetype-appointment-fourportal',
  templateUrl: './servicetype-appointment-fourportal.component.html',
  styleUrls: ['./servicetype-appointment-fourportal.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ServicetypeAppointmentFourportalComponent implements OnInit {
  ...
  constructor(
    ...
    if (this.stepOneId == null || this.insuranceId == null) {
      this.router.createUrlTree([`/insurance/make-appointment-claim/list/${this.loggedPortalType}`]);
    }
  ...
  getAllappointmentReason() {
    let reqData = {
      ...
      loginPortalId: this.doctorIdSelected,
      listFor: this.loggedPortalType,
