...
@Component({
  selector: 'app-esignature-appointment-fourportal',
  templateUrl: './esignature-appointment-fourportal.component.html',
  styleUrls: ['./esignature-appointment-fourportal.component.scss']
})
export class EsignatureAppointmentFourportalComponent implements OnInit {
