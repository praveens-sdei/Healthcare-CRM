...
@Component({
  selector: 'app-documentupload-appointment-fourportal',
  templateUrl: './documentupload-appointment-fourportal.component.html',
  styleUrls: ['./documentupload-appointment-fourportal.component.scss']
})
export class DocumentuploadAppointmentFourportalComponent implements OnInit {
