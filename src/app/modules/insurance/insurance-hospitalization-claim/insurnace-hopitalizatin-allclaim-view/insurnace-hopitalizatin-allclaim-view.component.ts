...
@Component({
  selector: 'app-insurnace-hopitalizatin-allclaim-view',
  templateUrl: './insurnace-hopitalizatin-allclaim-view.component.html',
  styleUrls: ['./insurnace-hopitalizatin-allclaim-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsurnaceHopitalizatinAllclaimViewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.roleName = JSON.parse(localStorage.getItem("loginData"));
  ...
  getMedicineClaimList(sort: any = '') {
    let reqData = {
      ...
      page: this.page,
      limit: this.pageSize,
      insuranceStaffRole: this.roleName.role,
    ...
    this.service.hospitalizationClaimListHospitalclaimAllListFinalExtension(reqData).subscribe(
      (res) => {
  ...
  countClaims() {
    ...
    this.service.hospitalizationCountByStatusInsuranceAdmin(reqData).subscribe((res) => {
      let response = this.coreService.decryptObjectData({ data: res });
  ...
  async handleViewDetails(claimId) {
    console.log(claimId);
    this.router.navigate(["/insurance/hospitalization/details"], {
      queryParams: {
        claimId: claimId,
      },
    });
  ...
  exportLab() {
    ...
    this.service.hospitalizationClaimListHospitalclaimAllListFinalExtension(reqData).subscribe((res) => {
      let response = this.coreService.decryptObjectData({ data: res });
