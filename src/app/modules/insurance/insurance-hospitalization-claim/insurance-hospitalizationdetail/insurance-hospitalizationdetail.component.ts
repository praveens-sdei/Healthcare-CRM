...
@Component({
  selector: 'app-insurance-hospitalizationdetail',
  templateUrl: './insurance-hospitalizationdetail.component.html',
  styleUrls: ['./insurance-hospitalizationdetail.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceHospitalizationdetailComponent implements OnInit {
  ...
  claimDetailsPreauthReclaimId: any;
  claimdetails: any = [];
  ...
  checkInnerPermission() {
    ...
    if (checkData) {
      if (checkData.isChildKey == true) {
        ...
        if (checkSubmenu.hasOwnProperty("insurance-hospitalization")) {
          this.innerMenuPremission = checkSubmenu['insurance-hospitalization'].inner_menu;
  ...
  async getClaimDetails(type: any = '') {
    let reqData = {
    ...
    console.log(reqData, "CLAIM ID=>", this.claimId, "ioio", this.AdminData, "type", type);
    ...
    // let staffRoleIDRole = this.AdminData.role.filter(obj => {
    //   console.log(obj, "check obj");
    //   return obj._id; // Filtering based on truthy _id property
    // });
    // console.log(reqData, "CLAIM ID=>", this.claimId, "pppstaffRoleIDRole", staffRoleIDRole);
    ...
    this.service.claimDetails(reqData).subscribe(
      {
        next: async (res) => {
          ...
          this.claimdetails.push({
            requestTypeHeading: this.claimDetails?.requestType,
            hospitalservicedatas: this.claimDetails?.hospitalservicedatas[0]
          })
          console.log(this.claimdetails, "check log claimdetails");


          if (this.claimDetails.preAuthReclaimId != "" && this.claimDetails.preAuthReclaimId != null) {
            console.log("00000");

            let reqData = {
              claimId: this.claimDetails.preAuthReclaimId,
              // insuranceStaffId: "6392fc4b8d7930a363b4c401",
              insuranceStaffId: this.userID,
              insuranceStaffRole: "",
            };
            ...
            this.service.claimDetails(reqData).subscribe(
              {
                next: async (res) => {
                  ...
                  console.log("Claim Details---->123", response);



                  this.claimDetailsPreauthReclaimId = response?.data?.result;
                  this.claimdetails.push({
                    requestTypeHeading: this.claimDetailsPreauthReclaimId?.requestType,
                    hospitalservicedatas: this.claimDetailsPreauthReclaimId?.hospitalservicedatas[0]
                  })

                  if (this.claimDetailsPreauthReclaimId.preAuthReclaimId != "" && this.claimDetailsPreauthReclaimId.preAuthReclaimId != null) {
                    console.log("00000");

                    let reqData = {
                      claimId: this.claimDetailsPreauthReclaimId.preAuthReclaimId,
                      // insuranceStaffId: "6392fc4b8d7930a363b4c401",
                      insuranceStaffId: this.userID,
                      insuranceStaffRole: "",
                    };
                    ...
                    this.service.claimDetails(reqData).subscribe(
                      {
                        next: async (res) => {
                          ...
                          this.claimdetails.push({
                            requestTypeHeading: response?.data?.result.requestType,
                            hospitalservicedatas: response?.data?.result?.hospitalservicedatas[0]
                          })

                          if (response?.data?.result.preAuthReclaimId != "" && response?.data?.result.preAuthReclaimId != null) {
                            console.log("00000");

                            let reqData = {
                              claimId: response?.data?.result.preAuthReclaimId,
                              // insuranceStaffId: "6392fc4b8d7930a363b4c401",
                              insuranceStaffId: this.userID,
                              insuranceStaffRole: "",
                            };
          ...
          console.log(this.medicineList, "checklist medicine");
          ...
          //   if (this.claimDetails?.is_approved_by_receptionist) {
          //     this.displayedColumnses.splice(8, 0, "medicalanalysis");
          //     this.displayedColumnses.splice(9, 0, "medicalAdvisorResponse");
          //     this.displayedColumnses.splice(10, 0, "contractAdvisorResponse");
          //     this.displayedColumnses.splice(
          //       11,
          //       0,
          //       "approveAmountByConAdvisor"
          //     );
          //     this.displayedColumnses.splice(12, 0, "cfoResponse");
          //     this.displayedColumnses.splice(13, 0, "approvedAmountByCfo");
          //   } else {
          //     this.displayedColumnses.splice(8, 0, "medicalanalysis"); //same coulumn name in ts  for all role but diffrnt in html
          //     this.displayedColumnses.splice(9, 0, "comments");
          //   }
          // }

          // if (this.staffRole === "Contract Advisor") {
          //   if (this.claimDetails?.is_approved_by_contract_advisor) {
          //     this.displayedColumnses.splice(9, 0, "receptionists");
          //     this.displayedColumnses.splice(10, 0, "medicalAdvisorResponse");
          //     this.displayedColumnses.splice(11, 0, "cfoResponse");
          //     this.displayedColumnses.splice(12, 0, "approvedAmountByCfo");
          //     this.displayedColumnses.splice(13, 0, "medicalanalysis");
          //     this.displayedColumnses.splice(14, 0, "approveAmountByConAdvisor");
          //     this.displayedColumnses.splice(15, 0, "comments");
          //   } else {
          //     this.displayedColumnses.splice(9, 0, "receptionists");
          //     this.displayedColumnses.splice(10, 0, "medicalAdvisorResponse");
          //     this.displayedColumnses.splice(11, 0, "medicalanalysis");
          //     this.displayedColumnses.splice(12, 0, "approveAmountByConAdvisor"
          //     );
          //     this.displayedColumnses.splice(13, 0, "comments");
          //   }
          // }
  ...
  handleSend(status) {
    ...
    this.service.addClaimForInsuranceStaff(reqData).subscribe((res) => {
      ...
      if (response.status) {
        ...
        this.router.navigate(["/insurance/policyclaim"]);
      }
    });
  }
  ...
  async extractPreviousClaims(previousClaims) {
    ...
    await previousClaims.forEach((element) => {
      ...
      if (element.requestType === "Hospitalization Statement" && element.claimId != this.claimId) {
  ...
  async handleViewPreviousClaim(claimId) {
    ...
    let url = `insurance/make-hospitalization-claim/details/${claimId}`;
  ...
  routeToClaimList() {
    this.router.navigate(["/make-hospitalization-claim/medicines"]);
  }
