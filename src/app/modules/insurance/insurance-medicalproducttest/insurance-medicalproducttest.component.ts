...
@Component({
  selector: 'app-insurance-medicalproducttest',
  templateUrl: './insurance-medicalproducttest.component.html',
  styleUrls: ['./insurance-medicalproducttest.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceMedicalproducttestComponent implements OnInit {
...
console.log("element--------------",element);
  ...
  getOthersDetails(id) {
    ...
    this.service.otherInfoDetailsApi(otherID).subscribe((res) => {
      let response = this._coreService.decryptObjectData({ data: res });
      this.infoDetails = response?.data;
      console.log("infoDetails123",this.infoDetails);
