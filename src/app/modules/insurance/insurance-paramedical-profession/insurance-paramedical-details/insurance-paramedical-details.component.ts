...
@Component({
  selector: 'app-insurance-paramedical-details',
  templateUrl: './insurance-paramedical-details.component.html',
  styleUrls: ['./insurance-paramedical-details.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceParamedicalDetailsComponent implements OnInit {
  ...
  handleSend(status) {
    ...
    this.service.addClaimForInsuranceStaff(reqData).subscribe((res) => {
      ...
      if (response.status) {
        ...
        this.router.navigate(["/insurance/paramedical-professions"]);
      }
    });
  }
  ...
  async handleViewPreviousClaim(claimId) {
    ...
    let url = `insurance/paramedical-professions/details/${claimId}`;
  ...
  routeToClaimList() {
    this.router.navigate(["/paramedical-professions/medicines"]);
  }
