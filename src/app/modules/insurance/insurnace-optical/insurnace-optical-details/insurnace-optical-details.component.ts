...
@Component({
  selector: 'app-insurnace-optical-details',
  templateUrl: './insurnace-optical-details.component.html',
  styleUrls: ['./insurnace-optical-details.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsurnaceOpticalDetailsComponent implements OnInit {
  ...
  handleSend(status) {
    ...
    this.service.addClaimForInsuranceStaff(reqData).subscribe((res) => {
      ...
      if (response.status) {
        ...
        this.router.navigate(["/insurance/optical-claim"]);
      }
    });
  }
  ...
  async handleViewPreviousClaim(claimId) {
    ...
    let url = `insurance/optical-claim/details/${claimId}`;
  ...
  routeToClaimList() {
    this.router.navigate(["/optical-claim/medicines"]);
  }
