...
@Component({
  selector: 'app-insurnace-optical-view',
  templateUrl: './insurnace-optical-view.component.html',
  styleUrls: ['./insurnace-optical-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsurnaceOpticalViewComponent implements OnInit {
  ...
  checkInnerPermission(){
    ...
    if(checkData){
      if(checkData.isChildKey == true){
        ...
        if (checkSubmenu.hasOwnProperty("optical_claim")) {
          this.innerMenuPremission = checkSubmenu['optical_claim'].inner_menu;
  ...
  async handleViewDetails(claimId) {
    console.log(claimId);
    this.router.navigate(["/insurance/optical-claim/details"], {
      queryParams: {
        claimId: claimId,
      },
    });
