...
export class ServicetypeComponent implements OnInit {
    ...
    categoryList: any = []; healthPlanId: any;
    ...
    constructor(
        ...
        console.log(this.stepOneId, "this.stepOneId");
        ...
        this.insuranceSubcription = this.coreService.SharingInsId.subscribe(
            (res) => {
                if (res != "default") {
                    ...
                    this.stepOneId = this.coreService.getSessionStorage("stepOneId");
                    this.costForService = {};
                    console.log(this.stepOneId, "this.stepOneId555");
                    // this.selectedservice = this.coreService.getSessionStorage("service");
                    this.selectedsubscriberid =
                        this.coreService.getSessionStorage("subscriberid");
    ...
    onSubmit() {
        ...
        if (allSame) {
            ...
            let reqData = {
                ...
                loggedInInsuranceId: this.pharmacyId,
            };
    ...
    getPortalTypeAndInsuranceId() {
        this.categoryList = [];
        let data = {
            insuranceId: this.pharmacyId,
            portalType: "Insurance",
        };
        console.log(this.insuranceId, "9090");
