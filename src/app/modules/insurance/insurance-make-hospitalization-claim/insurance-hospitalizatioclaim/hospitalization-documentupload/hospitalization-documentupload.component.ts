...
@Component({
  selector: 'app-hospitalization-documentupload',
  templateUrl: './hospitalization-documentupload.component.html',
  styleUrls: ['./hospitalization-documentupload.component.scss']
})
export class HospitalizationDocumentuploadComponent implements OnInit {
