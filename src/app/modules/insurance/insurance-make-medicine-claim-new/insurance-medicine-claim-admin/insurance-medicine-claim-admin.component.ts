...
@Component({
  selector: 'app-insurance-medicine-claim-admin',
  templateUrl: './insurance-medicine-claim-admin.component.html',
  styleUrls: ['./insurance-medicine-claim-admin.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceMedicineClaimAdminComponent implements OnInit {
  ...
  editclaim(claim_id) {
    this.router.navigate(["/insurance/insurance-makemedicineclaim/submitclaim"], {
  ...
  getMedicineClaimList(sort: any = '') {
    ...
    this.pharmacyPlanService.medicineListInsuranceAdmin(reqData).subscribe(
      (res) => {
  ...
  countClaims() {
    this.pharmacyPlanService
      .medicineClaimCountByStatusInsuranceAdminMedicine(this.userID, this.userID)
      .subscribe((res) => {
        let response = this.coreService.decryptObjectData({ data: res });
  ...
  async handleViewDetails(claimId) {
    console.log(claimId);
    this.router.navigate(["/insurance/insurance-makemedicineclaim/details"], {
      queryParams: {
        claimId: claimId,
      },
    });
  ...
  exportLab() {
    ...
    this.pharmacyPlanService.medicineListInsuranceAdmin(reqData).subscribe((res) => {
      let response = this.coreService.decryptObjectData({ data: res });
