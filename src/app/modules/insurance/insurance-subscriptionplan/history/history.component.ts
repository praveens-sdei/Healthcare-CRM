...
export class HistoryComponent implements OnInit {
  ...
  displayedColumns: string[] = ['purchasedate', 'subscriptionplanname','features', 'invoiceno', 'planprice', 'plantype', 'expirydate', 'status', 'action'];
  ...
  constructor(private insuranceService: InsuranceService, private _coreService: CoreService) {
