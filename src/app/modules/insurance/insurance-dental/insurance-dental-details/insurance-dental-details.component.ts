...
@Component({
  selector: 'app-insurance-dental-details',
  templateUrl: './insurance-dental-details.component.html',
  styleUrls: ['./insurance-dental-details.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceDentalDetailsComponent implements OnInit {
...
giveInnerPermission(value) {
  ...
  async handleViewPreviousClaim(claimId) {
    ...
    let url = `insurance/medicalconsultation/details/${claimId}`;
