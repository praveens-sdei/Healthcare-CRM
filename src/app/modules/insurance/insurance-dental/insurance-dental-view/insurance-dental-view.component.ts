...
@Component({
  selector: 'app-insurance-dental-view',
  templateUrl: './insurance-dental-view.component.html',
  styleUrls: ['./insurance-dental-view.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceDentalViewComponent implements OnInit {
  ...
  checkInnerPermission(){
    ...
    if(checkData){
      if(checkData.isChildKey == true){
        ...
        if (checkSubmenu.hasOwnProperty("dental-claim")) {
          this.innerMenuPremission = checkSubmenu['dental-claim'].inner_menu;
