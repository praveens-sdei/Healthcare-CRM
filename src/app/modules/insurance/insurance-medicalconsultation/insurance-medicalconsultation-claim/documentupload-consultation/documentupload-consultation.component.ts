...
@Component({
  selector: 'app-documentupload-consultation',
  templateUrl: './documentupload-consultation.component.html',
  styleUrls: ['./documentupload-consultation.component.scss']
})
export class DocumentuploadConsultationComponent implements OnInit {
