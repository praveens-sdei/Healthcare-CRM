...
@Component({
  selector: 'app-insurance-medicalconsultationview',
  templateUrl: './insurance-medicalconsultationview.component.html',
  styleUrls: ['./insurance-medicalconsultationview.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceMedicalconsultationviewComponent implements OnInit {
...
console.log("checkSubmenu_________")
    ...
    if(checkData){
      if(checkData.isChildKey == true){
        ...
        console.log("checkSubmenu_________",checkSubmenu)
        if (checkSubmenu.hasOwnProperty("medical-consultation")) {
          this.innerMenuPremission = checkSubmenu['medical-consultation'].inner_menu;
