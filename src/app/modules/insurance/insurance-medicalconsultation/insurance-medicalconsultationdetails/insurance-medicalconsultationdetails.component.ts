...
@Component({
  selector: 'app-insurance-medicalconsultationdetails',
  templateUrl: './insurance-medicalconsultationdetails.component.html',
  styleUrls: ['./insurance-medicalconsultationdetails.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceMedicalconsultationdetailsComponent implements OnInit {
  ...
  async extractPreviousClaims(previousClaims) {
    ...
    await previousClaims.forEach((element) => {
      ...
      if (element.claimType === "medicalConsultation" && element.claimId != this.claimId) {
