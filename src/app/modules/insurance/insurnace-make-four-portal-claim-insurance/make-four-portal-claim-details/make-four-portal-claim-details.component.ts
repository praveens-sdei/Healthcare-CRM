...
@Component({
  selector: 'app-make-four-portal-claim-details',
  templateUrl: './make-four-portal-claim-details.component.html',
  styleUrls: ['./make-four-portal-claim-details.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class MakeFourPortalClaimDetailsComponent implements OnInit {
