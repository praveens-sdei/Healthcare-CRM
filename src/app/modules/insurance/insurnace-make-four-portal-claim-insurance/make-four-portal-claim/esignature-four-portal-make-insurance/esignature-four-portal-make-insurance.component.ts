...
@Component({
  selector: 'app-esignature-four-portal-make-insurance',
  templateUrl: './esignature-four-portal-make-insurance.component.html',
  styleUrls: ['./esignature-four-portal-make-insurance.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class EsignatureFourPortalMakeInsuranceComponent implements OnInit {
