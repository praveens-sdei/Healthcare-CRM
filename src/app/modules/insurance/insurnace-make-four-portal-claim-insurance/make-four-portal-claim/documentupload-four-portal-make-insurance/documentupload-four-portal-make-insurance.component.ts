...
@Component({
  selector: 'app-documentupload-four-portal-make-insurance',
  templateUrl: './documentupload-four-portal-make-insurance.component.html',
  styleUrls: ['./documentupload-four-portal-make-insurance.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DocumentuploadFourPortalMakeInsuranceComponent implements OnInit {
