...
@Component({
  selector: 'app-insurance-appointment-all-list',
  templateUrl: './insurance-appointment-all-list.component.html',
  styleUrls: ['./insurance-appointment-all-list.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class InsuranceAppointmentAllListComponent implements OnInit {
  ...
  checkInnerPermission(){
    ...
    if(checkData){
      if(checkData.isChildKey == true){
        ...
        if(this.loggedPortalType === 'Dental'){
        ...
        if(this.loggedPortalType === 'Optical'){
        ...
        if(this.loggedPortalType === 'Laboratory-Imaging'){
        ...
        if(this.loggedPortalType === 'Paramedical-Professions'){
  ...
  getMedicineClaimList(sort: any = '') {
    ...
    this.service.appointmentClaimListInsuranceAdminAll(reqData).subscribe(
      (res) => {
  ...
  countClaims() {
    ...
    this.service.appointmentClaimStatusInsuranceAllView(reqData).subscribe((res) => {
      let response = this.coreService.decryptObjectData({ data: res });
  ...
  exportLab() {
    ...
    this.service.appointmentClaimListInsuranceAdminAll(reqData).subscribe((res) => {
      let response = this.coreService.decryptObjectData({ data: res });
