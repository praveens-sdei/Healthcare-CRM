...
@Component({
  selector: 'app-insurance-logs',
  templateUrl: './insurance-logs.component.html',
  styleUrls: ['./insurance-logs.component.scss']
})

export class InsuranceLogsComponent implements OnInit {
  ...
  constructor(private service: InsuranceService, private _coreService: CoreService,) {
